 ...
 * Spawns particles that move and connect with lines when close to each other.
 * Mimics a neural network or constellation effect.
 */
    ...
    for (let a = 0; a < particlesArray.length; a++) {
        for (let b = a; b < particlesArray.length; b++) {
            ...
            if (distance < (canvas.width / 7) * (canvas.height / 7)) {
                ...
                ctx.strokeStyle = 'rgba(255, 215, 0,' + opacityValue + ')'; // Gold with opacity
                ctx.lineWidth = 1;
                ctx.beginPath();
